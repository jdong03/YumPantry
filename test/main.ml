...
(*
        ...
        - Match:   The Match module was tested to ensure proper matching of ingredients
                    and quantities in a pantry to the ingredients and quantities
                    required in a recipe. Tests were also written to verify that
                    the module was able to get a recipe given its name. 
        ...
        - Ingredient: Ingredient tests primarily utilized black box testing,
                      ...
                      calculations.
        - Match:    Match tests primarily utilized black box testing, focusing on
                    the user's interaction with the match system, such as getting
                    a recipe, and finding the recipes that could be prepared given
